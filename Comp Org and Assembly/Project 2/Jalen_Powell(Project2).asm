...
value from an array, add another
; value to this, and save the sum of those two into a specific 
register.
; Author: Jalen Powell
; Date: 2-11-2022
...
; Sums in the high position of the DX register
mov dh, [input+6]
add dh, shift

; Sums in the low position of the DX register
mov dl, [input+7]
add dl, shift
